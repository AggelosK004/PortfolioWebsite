...
import { playQuack } from "../utils/playQuack";
...
export default function Contact() {
  ...
  const [duckCelebrate, setDuckCelebrate] = useState(false);
  const celebrateTimeoutRef = useRef(null);

  const celebrateDuck = () => {
    playQuack();
    setDuckCelebrate(true);
  ...
  return (
    <Box
      id="contact"
      sx={{ py: { xs: 4, sm: 6, md: 8 }, px: 2, mb: { xs: 4, sm: 6, md: 8 } }}
    >

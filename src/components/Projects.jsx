...
export default function Projects() {
  return (
    <Box id="experience" sx={{ py: { xs: 4, sm: 6, md: 8 }, px: 2 }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Typography
                      variant="h5"
                      component={project.titleUrl ? "a" : "div"}
                      href={project.titleUrl}
                      target={project.titleUrl ? "_blank" : undefined}
                      rel={project.titleUrl ? "noopener noreferrer" : undefined}
                      sx={{
                        display: "flex",
                        justifyContent: "center",
                        alignItems: "center",
